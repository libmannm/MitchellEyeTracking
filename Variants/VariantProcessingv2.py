...
class VariantProcess():
    def __init__(self, dataPath, referencePath,output, seconds = 0):
        ...
        self.output = output
        self.output["Participant"].append(fileID)    
        ...
        for i,j in enumerate(self.indeces):
            ...
            self.output[self.numNames[i]].append(np.nanmean(subsect)-self.baseline[i])
...
dataPath = ["M:\\Research\\Kaiyo\\Variants\\Variant Raw Sensor Data\\001_109CE Letter 03-08-22 14h22mfiltered.csv",
            "M:\\Research/Kaiyo\\Variants\\Variant Raw Sensor Data\\002_109CE Arrow 03-08-22 13h41mfiltered.csv"]
referencePath = ["M:\\Research\\Kaiyo\\Variants\\Variant Raw Sensor Data\\Timestamps\\LetterTask_109CE_3_1_2022_Aug_03_1425.csv",
                 "M:\\Research\\Kaiyo\\Variants\\Variant Raw Sensor Data\\Timestamps\\Arrow_ArrowRV_109CE_4_1_2022_Aug_03_1345.csv"]
time = 25
#Use if new
...
with open("M:\\Research\\Kaiyo\\Variants\\Variant Raw Sensor Data\\23Seconds.json", "w") as outfile:
